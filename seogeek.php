...
<body>
    ...
    <div class="row gy-5">
        ...
        <div class="col-sm-6 ">
            <div class="card " id="item1" style=" position: relative; margin: 2%; padding: 2%; box-shadow: 10px 10px 5px lightslategray; ">
                <img src="assets/seogeek/s1.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Sahil Patel <br> SEO engineer<br>Ratings 5.0⭐ ⭐ ⭐ ⭐ ⭐</h5>
                    <p class="card-text"></p>
        ...
        <div class="col-sm-6">
            <div class="card " style="margin: 2%; padding: 2%; position: relative; margin-left: 2%;  box-shadow: 10px 10px 5px lightslategray; ">
                <img src="assets/seogeek/s2.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Sahil Patel <br> SEO engineer<br>Ratings 5.0⭐ ⭐ ⭐ ⭐ ⭐</h5>
                    <p class="card-text"></p>
    ...
    <div class="row gy-5">
        ...
        <div class="col-sm-6">
            <div class="card " style="margin: 2%; padding: 2%; position: relative; margin-left: 5%;  box-shadow: 10px 10px 5px lightslategray; ">
                <img src="assets/seogeek/s3.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Shashank Kenny <br> SEO engineer<br>Ratings 5.0⭐ ⭐ ⭐ ⭐ ⭐</h5>
                    <p class="card-text"></p>
        ...
        <div class="col-sm-6">
            <div class="card " style="margin: 2%; padding: 2%; position: relative; margin-left: 2%;  box-shadow: 10px 10px 5px lightslategray; ">
                <img src="assets/seogeek/s4.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Karan Panchal <br> SEO engineer<br>Ratings 5.0⭐ ⭐ ⭐ ⭐ ⭐</h5>
                    <p class="card-text"></p>

                    <p class="card-text">Professional SEO engineer.
                    </p>
                    <a href="" class="btn btn-primary" onmouseover="this.style.color='blue'" onmouseout="this.style.color='white'">Hire Me</a>
                </div>
            </div>
    ...
    <div class="row gy-5">
        ...
        <div class="col-sm-6">
            <div class="card " style="margin: 2%; padding: 2%; position: relative; margin-left: 5%;  box-shadow: 10px 10px 5px lightslategray; ">
                <img src="assets/seogeek/s5.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Mahesh Goud <br> SEO engineer<br>Ratings 5.0⭐ ⭐ ⭐ ⭐ ⭐</h5>
                    <p class="card-text"></p>

                    <p class="card-text">Experinced SEO Engineer</p>
                    <br>
                    <a href="" class="btn btn-primary" onmouseover="this.style.color='blue'" onmouseout="this.style.color='white'">Hire Me</a>
                </div>
            </div>
        ...
        <div class="col-sm-6 ">
            <div class="card " style="margin: 2%; padding: 2%; position: relative; margin-left: 2%;  box-shadow: 10px 10px 5px lightslategray; ">
                <img src="assets/seogeek/s6.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Lokesh Reddy <br> SEO engineer<br>Ratings 5.0⭐ ⭐ ⭐ ⭐ ⭐</h5>
                    <p class="card-text"></p>

                    <p class="card-text">Best SEO Engineer
                    </p>
                    <a href="" class="btn btn-primary" onmouseover="this.style.color='blue'" onmouseout="this.style.color='white'">Hire Me</a>
                </div>
            </div>
